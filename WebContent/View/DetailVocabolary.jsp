...
<jsp:include page="Header.jsp"/>
	...
	<c:forEach items = "${listvocabulary}" var = "list">
		<div class="span6">
		<div class="media">
				 <a href="#" class="pull-left"><img src="ImageUpload/${list.image}" class="media-object" alt='' height="150" width="150"/></a>
				 <p>${list.num}</p>
...
<div class="pagination" style ="padding-top: 70px">
	   ...
	   <li><a href = "ListVocabulary?vocabularyguidelineid=${vocabularyguidelineid}&&pageid=${numberpage+1}">Next</a></li>
</c:if>

 <c:if test ="${numberpage == maxpageid}">
	   <li><a href = "ListVocabulary?vocabularyguidelineid=${vocabularyguidelineid}&&pageid=${numberpage-1}">Prev</a></li>
