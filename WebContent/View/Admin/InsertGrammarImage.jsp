								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action = "UploadImageGrammarController?grammarguidelineid=<%=request.getAttribute("grammarguidelineid")%>" method = "post" enctype="multipart/form-data">
												<fieldset>
													<label class="block clearfix">
													<%= request.getAttribute("msggrammarimage")!= null?request.getAttribute("msggrammarimage"): " "  %>
													</label>
													<label class="block clearfix">
