...
<div class="main-container ace-save-state" id="main-container">
			...
			<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<li>
								<a href="GrammarGuidelineForward?pageid=1">Grammar</a>
							</li>
							<li class="active">Lession list</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class ="page-content">
							<c:if test="${msglistgrammar!= null}">
							

								<h4 class="pink">
									<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i>
									<a class="green" data-toggle="modal">${msglistgrammar}</a>
								</h4>
									...
									<thead>
											...
											<tr>
												...
												<td class="center">
													...
													<td class="center">
														<a class="red" href="DeleteGrammarForward?grammarguidelineid=${list.grammarguidelineid}">
																	<i class="ace-icon fa fa-trash-o bigger-130"></i>
																</a>
													</td>
													<td class="center">
													<c:if test="${list.content != null}">
														<a class="green" href="GrammarGuidelineContentForward?grammarguidelineid=${list.grammarguidelineid}">
																	<i class="ace-icon fa fa-check"></i>
																</a>
														
												</c:if>
												<c:if test="${list.content == null}">
														<a class="red" href="GrammarGuidelineContentForward?grammarguidelineid=${list.grammarguidelineid}">
										...
										<div>
											<ul class="pagination">
												 ...
												 <c:if test ="${numberpage == 1}">
	  												 ...
	  												 <li><a href = "ListGrammarGuidelineForward?pageid=${numberpage+1}">Next</a></li>
													</c:if>

													 <c:if test ="${numberpage == maxpageid}">
	  												 <li><a href = "ListGrammarGuidelineForward?pageid=${numberpage-1}">Prev</a></li>

	  												 <li class = "active"><a href = "#">Next</a></li>
													</c:if>

													<c:if test ="${numberpage >1 && numberpage <maxpageid}">
	  												 <li><a href = "ListGrammarGuildelineForward?pageid=${numberpage-1}">Prev</a></li>
	
	   												<li><a href = "ListGrammarGuildelineForward?pageid=${numberpage+1}">Next</a></li>
</c:if>
...
<div class="modal fade" id="myModal" role="dialog">
  ...
  <!-- Modal content-->
  <form action="InsertNameGrammarController" method = "post">
...
<div class="form-group" style = "padding-bottom: 30px; padding-left: 100px;">
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" placeholder="Insert Title" class="form-control" name = "grammarname" />
										</div>
        </div>
        </div>
