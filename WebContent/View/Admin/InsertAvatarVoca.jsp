						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white" id="id-text2">Insert Avatar</span>
								</h1>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action = "InsertAvatarVocaController?vocabularyguidelineid=<%=request.getAttribute("vocabularyguidelineid")%>" method = "post" enctype="multipart/form-data">
												<fieldset>
													<label class="block clearfix">
													<%= request.getAttribute("msgvocaimage")!= null?request.getAttribute("msgvocaimage"): " "  %>
													</label>
													<label class="block clearfix">
