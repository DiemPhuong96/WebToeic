...
<div class="main-container ace-save-state" id="main-container">
			...
			<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<li>
								<a href="VocabularyForward?pageid=1">Vocabulary</a>
							</li>
					...
					<div class ="page-content">
							<c:if test="${msglistvoca!= null}">
							

								<h4 class="pink">
									<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i>
									<a class="green" data-toggle="modal">${msglistvoca}</a>
								</h4>
						...
						<div>
									...
									<thead>
											...
											<c:forEach  items = "${listvoca}" var = "list">
											<tr>
												<td class= "center">
												...
												<td class="center">
													...
													<td class="center">
														${list.vocabularyimage}
													</td>
													<td class="center">
														<a class="red" href="DeleteVocaForward?vocabularyguidelineid=${list.vocabularyguidelineid}">
																	<i class="ace-icon fa fa-trash-o bigger-130"></i>
																</a>
													</td>
													<td class="center">
													
														<a class="green" href="VocabularyContentForward?vocabularyguidelineid=${list.vocabularyguidelineid}">
										...
										<div>
											<ul class="pagination">
												 ...
												 <c:if test ="${numberpage == 1&&maxpageid!=0}">
	  												 ...
	  												 <li><a href = "VocabularyForward?pageid=${numberpage+1}">Next</a></li>
													</c:if>

													 <c:if test ="${numberpage == maxpageid}">
	  												 <li><a href = "VocabularyForward?pageid=${numberpage-1}">Prev</a></li>
...
<div class="modal fade" id="myModal" role="dialog">
  ...
  <!-- Modal content-->
  <form action="InsertNameOfTopicForward" method = "post">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Insert Topic</h4>
        </div>
        <div class="modal-body">
          
<div class="form-group" style = "padding-bottom: 30px; padding-left: 100px;">
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" placeholder="Insert the name of the topic" class="form-control" name = "TopicName" />
										</div>
        </div>
        </div>
