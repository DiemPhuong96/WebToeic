						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white" id="id-text2">Insert Avatar for a new word</span>
								</h1>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="InsertImageAudioVoca" method="POST" enctype="multipart/form-data">
												<fieldset>
													<label class="block clearfix">
														<%=request.getAttribute("msgimagaudio")!=null?request.getAttribute("msgimagaudio"):" "%>
													</label>
													...
													<div class="clearfix">
														...
														<input type="submit" value="Submit" class="btn btn-sm btn-primary">
													 	<input id="addFile" type="button" value="Add file" class="btn btn-sm btn-primary"/>
