...
<div class="main-container ace-save-state" id="main-container">
			...
			<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<li>
								<a href="ExamTestForward?pageid=1"></a>
							</li>
					...
					<div class ="page-content">
							<c:if test="${msgexamtest!= null}">
							

								<h4 class="pink">
									<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i>
									<a class="green" data-toggle="modal">${msgexamtest}</a>
								</h4>
						...
						<div>
									...
									<thead>
											...
											<c:forEach  items = "${listexamtest}" var = "list">
											<tr>
												<td class= "center">
												${list.examinationid}
												</td>
												<td class="center">
													...
													<td class="center">
														<a class="red" href="DeleteExamForward?examinationid=${list.examinationid}">
												...
												<a class="green" href="UploadFileExamQuestionForward?examinationid=${list.examinationid}">
											...
											<ul class="pagination">
											 <c:if test ="${numberpage == 1}">
												 ...
												 <c:if test ="${numberpage == 1&& maxpageid !=0}">
	  												 ...
	  												 <li><a href = "ExamForward?pageid=${numberpage+1}">Next</a></li>
													</c:if>

													 <c:if test ="${numberpage == maxpageid}">
	  												 <li><a href = "ExamForward?pageid=${numberpage-1}">Prev</a></li>
...
<!-- modal them hinh anh va tieu de -->
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
  <!-- Modal content-->
  <form action="InsertTitleExam" method = "post">
...
<div class="form-group" style = "padding-bottom: 30px; padding-left: 100px;">
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" placeholder="Insert Title" class="form-control" name = "examinationname" />
										</div>
        </div>
        </div>
