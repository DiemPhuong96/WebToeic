								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action = "UploadFileExamQuestionForward?examinationid=<%=request.getAttribute("examinationid")%>" method = "post" enctype="multipart/form-data">
												<fieldset>
													<label class="block clearfix">
													<%= request.getAttribute("msgimageexam")!= null?request.getAttribute("msgimageexam"): " "  %>
													</label>
													<label class="block clearfix">
